const nextBtn = document.querySelector("#forwardIcon0");
const prevbtn = document.querySelector("#backIcon0");
const carouselSlide = document.querySelector("#slider");
const carouselImage = document.querySelector("#lastClone");


let carouselImages = ["image/Asus.jpg", "image/acernitro.jpg", "image/alienware.jpg"];
